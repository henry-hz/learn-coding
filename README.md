...
become a python programmer or data scientist in an easy and amazing interactive
learning.

This is what seems to be a good path to start with and have all the basics to succeed in
the long run. Read [this](http://www.paulgraham.com/knuth.html) article.
You should konw that if you understand the root of the computer science, you will be able to learn several languages much much faster that the ones that can't understand it. I finally found a course that teaches the principals: 
**[From Nan to Tetris](https://www.coursera.org/learn/build-a-computer)**

1. Learn Javascript and its derivatives (Nodejs, Angularjs) since it's is
...
After you got some experience with Javascript, consider learning Haskell, so it
will be easy to learn any other language. But programming is more than art and science, see [this](http://www.techrepublic.com/blog/10-things/10-traits-to-look-for-when-youre-hiring-a-programmer/) 10 traits
that you should also develop, and will for sure determine your relationship with the market.
...
Imagine you would like to open a car washing machine company. You go to buy the equipment, 
...
## Solving Problems
* [project-euler](https://projecteuler.net/) - global selection of interesting problems
  to solve
...
* [angular](https://www.codeschool.com/courses/shaping-up-with-angular-js) -
  google framework to develop web applications, good to know to find a job
...
## Functional Programming
* [basic-haskell](http://haskellbook.com/) - Beginners book
